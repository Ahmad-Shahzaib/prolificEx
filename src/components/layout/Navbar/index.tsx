...
import { toggleMobileMenu, closeMobileMenu, setActiveNavLink } from "@/redux/slices/uiSlice";
...
export function Navbar() {
  ...
  const { isMobileMenuOpen, activeNavLink } = useAppSelector((state) => state.ui);
  ...
  return (
    <nav className="absolute top-10 left-[100px] w-[1240px] h-16 flex items-center z-50">
      <div className="relative w-[129px] h-[51px]">
        <Image
      ...
      <div className="inline-flex items-center gap-5 absolute top-2 left-[1032px]">
        <button className="inline-flex items-center px-3 py-0.5 bg-transparent border-none cursor-pointer hover:text-white/80 transition-colors">
